export const KIROCREDABI = [
    ...
    items: [
      ...
      },
      {
        ...
        inputs: [
          ...
          { name: "org_pubkey", type: "core::felt252" },
        ],
        outputs: [],
        state_mutability: "external",
      },
      ...
      },
      {
        ...
        inputs: [{ name: "batch_id", type: "core::integer::u64" }],
        outputs: [{ type: "core::felt252" }],
        state_mutability: "view",
      },
      {
        type: "function",
        name: "get_issuer_public_key",
        inputs: [{ name: "batch_id", type: "core::integer::u64" }],
        outputs: [{ type: "core::felt252" }],
        state_mutability: "view",
      },
  ...
  },
  {
    ...
    kind: "struct",
    members: [
      { name: "root", type: "core::felt252", kind: "data" },
      { name: "batch_id", type: "core::integer::u64", kind: "data" },
    ],
  },
  {
    type: "event",
    ...
    members: [
      ...
      { name: "org_id", type: "core::integer::u64", kind: "data" },
    ],
  },
  {
    type: "event",
    ...
    kind: "struct",
    members: [{ name: "batch_id", type: "core::integer::u64", kind: "data" }],
  },
  {
    type: "event",
